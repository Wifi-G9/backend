...
class ChatGPTDescription(APIView):
    def get(self, request: Request) -> Response:
        """
               ...
               :param request: Request --- The request has query param 'message' and 'type' with values:
                        1 - for main page word description
                        2 - for user page photo description
        ...
        description_type = request.query_params.get("type", None)
        description = self.get_gpt_description(word_searched, description_type)
    ...
    @staticmethod
    def get_gpt_description(word: str, description_type: str) -> str | None:
        """
        Calls OpenAI GPT-3.5-turbo API to generate a description for the given word.
        :param word: str
        :param description_type: str (1/2)
        :return: string | None
        """
        ...
        if description_type == "2":
            prompt = f"Give me an instagram description for the following given description: '{word}'"
